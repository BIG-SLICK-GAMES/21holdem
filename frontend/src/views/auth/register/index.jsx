...
export default function Register() {
    ...
    return <Modal show centered scrollable className='register-dialog' onHide={() => navigate('/lobby')} backdrop={isLoading ? 'static' : true} keyboard={!isLoading} aria-labelledby='register-title'>
        <Modal.Header closeButton={!isLoading} closeLabel='Close registration'>
            <div><span className='register-dialog__eyebrow'>21 HOLD’EM · BIG SLICK GAMES</span><Modal.Title as='h1' id='register-title'>{createdEmail ? 'Check your inbox' : 'Join the table'}</Modal.Title></div>
        </Modal.Header>
        <Modal.Body>
            {createdEmail ? <div className='register-dialog__success'>
                ...
                <p className='register-dialog__intro'>Create your player account. Choose the name other players will see and keep your account secure.</p>
                ...
                <form onSubmit={handleSubmit(submit)} noValidate>
                    <fieldset disabled={isLoading}>
                        <div className='register-dialog__field'><label htmlFor='register-username'>Player name</label><p id='register-username-help'>At least 4 characters. This is your name at the table.</p>
