...
export default function PageHeading({ title, icon = 'cards', meta, information, as: Heading = 'h2', id }) {
    return (
        <>
        <header className='play-heading'>
            ...
            <div className='play-heading__text'><Heading id={id}>{title}</Heading></div>
