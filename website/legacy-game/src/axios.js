...
function removeToken() {
    if (typeof document !== "undefined") {
        document.cookie = "sAuthToken=; Path=/; Expires=Thu, 01 Jan 1970 00:00:01 GMT;";
    }
}
...
export function getApiRoot(url = process.env.NEXT_PUBLIC_GAME_API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE_URL) {
...
export function setUrl(url = process.env.NEXT_PUBLIC_GAME_API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE_URL, options = { prod: false }) {
...
const Axios = axios.create({
    ...
    baseURL: setUrl(process.env.NEXT_PUBLIC_GAME_API_BASE_URL || process.env.NEXT_PUBLIC_API_BASE_URL, { prod: false }),
